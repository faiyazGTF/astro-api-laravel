...
class CommonController extends Controller
{
    ...
    public function uploadfile(Request $request)
    {
        try {
            ...
            Storage::disk('s3')->putFileAs('public/other-files/'.$foldername,$file,$fileName);
    ...
    public function conferencingAstro(Request $request){
        try {
            ...
            ->select(
                'astro_conferencing.roomid','astro_conferencing.is_available', 'astro_conferencing.token',
                'users.id', 'users.name', 'users.mobile', 'users.email', 'users.user_type', 
                'users.created_at', 'users.image', 'users_details.*', 'users.name as profile_name_en',
                'mst_countries.country_name', 'mst_states.state_name', 'mst_cities.city_name'
            )
