        ...
        $country=101;
         ...
         $responsedata=[
          ...
          if(!empty($jsondata->address->city)){
            $city=DB::table('mst_cities')->where('city_name', 'LIKE', '%' . $jsondata->address->city . '%') ->pluck('id')->first();
            $responsedata['city']=[
              'id'=>$city,
          ...
          if(!empty($jsondata->address->state)){
              ...
              $state=DB::table('mst_states')->where('state_name', 'LIKE', '%' . $jsondata->address->state . '%') ->pluck('id')->first();
              $responsedata['state']=[
                  'id'=>$state,
            ...
            if(!empty($jsondata->address->country)){
                $country=DB::table('mst_countries')->where('country_name', 'LIKE', '%' . $jsondata->address->country . '%') ->pluck('id')->first();
